...
$myfile=fopen("kartyplayer.txt", "r");
$testy = fread($myfile,filesize("kartyplayer.txt"));
fclose($myfile);
...
<tr>
<td class="ccc" ><a href="index.php?pas=1">pas</a></td>
</tr>
</table>
...
$myfile=fopen("kartyplayer.txt", "r");
$stare = fread($myfile,filesize("kartyplayer.txt"));
fclose($myfile);
...
echo "$(\"#taliamoja\").html($(\"#taliamoja\").html()+'<span ><img width=\"50\" height=\"80\" src=\"k".$key9.".png\" onmouseover=\"wyswietl(\'k".$key9.".png\');\" onmouseout=\"schowaj();\" title=\"".$key[19]."\"></span><span style=\"display: inline-block\"><table style=\"border:0px;\"><tr><td style=\"width:50;height:26;\"><a href=\"index.php?id=".$key9."&okrzyk=miecz\"><img title=\"mroz\" style=\"width:50;height:26;\" src=\"mroz.jpg\"  ></a></td></tr><tr><td style=\"width:50;height:26;\"><a href=\"index.php?id=".$key9."&okrzyk=luk\"><img  title=\"mgla\" style=\"width:50;height:26;\" src=\"mgla.jpg\" class=\"traba\"></a></td ></tr><tr><td style=\"width:50;height:26;\"><a href=\"index.php?id=".$key9."&okrzyk=balista\"><img title=\"deszcz\" style=\"width:50;height:26;\" src=\"deszcz.jpg\" class=\"traba\"></a></span>');";
	
	
	}else{
		
echo "$(\"#taliamoja\").html($(\"#taliamoja\").html()+'<a href=\"index.php?id=".$key9."\"><img width=\"50\" height=\"80\" src=\"k".$key9.".png\" onmouseover=\"wyswietl(\'k".$key9.".png\');\" onmouseout=\"schowaj();\" title=\"".$key[19]."\"></a>');
...
if($koniec1==1 and $koniec2==1){
	...
	echo '<meta http-equiv="refresh" content="0; url=czekaj1.php?wynik='.$p.'">';
}
?>
...
$.get( "kolej.php", function( data ) {
	...
	if(data==1){
		...
		window.location="index.php?ko=3";
		
	}
	
		if(data==5){
		
		window.location="index.php?ko=6";
...
window.location="index.php";
		...
		//window.location="index.php?ko=2";
	}
...
echo '<meta http-equiv="refresh" content="1; url=index.php?ko=3">';
}
?>
...
//echo "$('#taljamoja').html($('#taliamoja').html()+'<a href='index.php?id=".$key9."'><img src=\'k".$key9.".png\' alt=\'".$key[19]."\'></a>'";
